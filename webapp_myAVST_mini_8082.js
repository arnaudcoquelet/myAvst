...
//***************************************************************************************//
	...
	notifyPlayerError : function(objEvent) {
		var data	= webapp.myAVST.data;
		data.updateAppBar(data.ERROR_STATUS);
		objEvent	= null;
	},
...
dojo.require("webapp.myAVST.controlBase");
dojo.provide("webapp.myAVST");
dojo.declare("webapp.myAVST",webapp.myAVST.controlBase,{});
webapp.myAVST=new webapp.myAVST();
...
dojo.require("webapp.myAVST.dataBase");
dojo.provide("webapp.myAVST.data");
dojo.declare("webapp.myAVST.data",webapp.myAVST.dataBase,{});
webapp.myAVST.data=new webapp.myAVST.data();
...
dojo.require("webapp.myAVST.getViewBase");
dojo.provide("webapp.myAVST.getView");
dojo.declare("webapp.myAVST.getView", webapp.myAVST.getViewBase,
	{
		templatePath:dojo.moduleUrl("webapp.myAVST","templates/getView8082.html"),
		cssFile : ['main.css', 'icons.css', 'main8052.css', 'main8082.css']
	}
);


dojo.provide("webapp.myAVST.getMessagePreviewBase");
dojo.declare("webapp.myAVST.getMessagePreviewBase",[ICTouchAPI.webWidget,dojox.dtl._Templated],{
	...
	postCreate : function() {
		...
		this.webapp.setPreviewContainer(new UIElements.Container.ContainerControl(
												...
												objTitle: { strLabel : "AVST Voice Mail"},
...
dojo.require("webapp.myAVST.getMessagePreviewBase");
dojo.provide("webapp.myAVST.getMessagePreview");
dojo.declare("webapp.myAVST.getMessagePreview", webapp.myAVST.getMessagePreviewBase,
	{
		templatePath: dojo.moduleUrl("webapp.myAVST","templates/getMessagePreview8082.html"),
		cssFile : ['main.css', 'icons.css', 'main8052.css', 'main8082.css']
	}
);
